    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="col-md-4"><a href="photos">Enter Photography Portfolio</a></li>
                <li class="col-md-4"><a href="">Enter Graphics Portfolio</a></li>
                <li class="col-md-4"><a href=""> Contact Cassia Berger</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="top-background">
    <div class="top-container info-container">
        <div class="row">
            <h1>Cassia Berger's Portfolio</h1>
        </div>
    </div>
</div>
